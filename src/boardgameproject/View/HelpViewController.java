...
public class HelpViewController implements Initializable {
    ...
    @FXML
    private Label OBlock, IBlockH, TBlockT, LBlockT, JBlockT, SBlockH, ZBlockH,
            IBlockT, TBlockD, TBlockR, TBlockL, LBlockD, LBlockR, LBlockL,
            JBlockD, JBlockR, JBlockL, SBlockT, ZBlockT;
    @FXML
    private Canvas OBlockCanvas, IBlockTCanvas, IBlockHCanvas, SBlockTCanvas,
            SBlockHCanvas, ZBlockTCanvas, ZBlockHCanvas, LBlockTCanvas,
            LBlockRCanvas, LBlockLCanvas, LBlockDCanvas, JBlockTCanvas,
            JBlockRCanvas, JBlockDCanvas, JBlockLCanvas, TBlockTCanvas,
            TBlockRCanvas, TBlockLCanvas, TBlockDCanvas;
     ...
     * and initialize all the help menu
     */
    @Override
